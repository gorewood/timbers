...
func (m *mockGitOpsForExport) IsOnFirstParentLine(sha, head string) bool {
	return true
}
...
func (m *mockGitOpsForExport) DiffNameOnly(fromRef, toRef, pathPrefix string) ([]string, error) {
	return nil, nil
}
